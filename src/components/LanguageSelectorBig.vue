...
">
    <li v-for="(lang, i) in languages" :key="i" :value="lang.value" class="lang-option">
      <img :src="lang.thumbnail" alt="" :value="lang.value" style="height:15px; margin-right: 15px" @click="switchLang"/>
...
methods: {
  toggleView () {
    ...
    list.forEach( l => l.style.top === '44px' ? l.style.top = '-60px' : l.style.top = '44px' )
